// Precisamos do espress para montar API
...
//Função para montar estado inicial dos cadidatos
...
app.get('/votes', (_, res) => {
  ...
  //Clonando objeto de votação e realizando a ordenação a partir de votos
